                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-6 product-block">
                        <div class="product-card">
                            ...
                            <form method="POST" action="{{ route('removeFromDeseos') }}"  role="form" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div >
                                <h3 class="text-center title"><a href="{{ route('verCurso',$curso->id) }}">{{ $curso->nombre }}</a></h3>
